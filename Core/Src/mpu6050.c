...
void MPU6050_CommentaryFilter(I2C_HandleTypeDef *I2Cx, MPU6050_t *DataStruct){
	  uint8_t Rec_Data[14];
    ...
    DataStruct->CompAngleX+=DataStruct->Gx*dt;
    DataStruct->CompAngleX=0.98*DataStruct->CompAngleX+0.02*roll;
